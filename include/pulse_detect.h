...
#define PD_MAX_PULSES 1500      // Maximum number of pulses before forcing End Of Package
...
#define PD_MAX_GAP_RATIO 20     // Ratio gap/pulse width to exceed to declare End Of Package (heuristic)
